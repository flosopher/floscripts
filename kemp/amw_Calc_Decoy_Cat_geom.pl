...
my $backedUpAtomName_alt = 0;
my $backingUpResNr = 0;
my $backingUpAtomName = 0;
my $backingUpAtomName_alt = 0;
my $backingUpResCAtomName = 0;
my $backingUpResName = 0;
my $buffer;
...
printf STDERR "Input given: %s %s %s %s %s\n",$design,$decoy,$BaseResName, $BaseResNr; 
...
else{ printf STDERR "Error: Correct base is not given: %s\n", $BaseResName; exit 1;}



if($backedUpAtomName eq "NE2"){$backedUpAtomName_alt = "ND1";}
elsif($backedUpAtomName eq "ND1"){$backedUpAtomName_alt = "NE2";}
else {printf STDERR "Error: No correct backed up atom given\n";}

if($backingUpAtomName eq "OE1"){$backingUpAtomName_alt = "OE2"; $backingUpResCAtomName = "CD";}
elsif($backingUpAtomName eq "OE2"){$backingUpAtomName_alt = "OE1"; $backingUpResCAtomName = "CD";}
elsif($backingUpAtomName eq "OD1"){$backingUpAtomName_alt = "OD2"; $backingUpResCAtomName = "CG";}
elsif($backingUpAtomName eq "OD2"){$backingUpAtomName_alt = "OD1"; $backingUpResCAtomName = "CG";}
...
my @backingUpAtom;
my @backedUpAtom_alt;
my @backingUpAtom_alt;
my @backingUpResCAtom;
...
while (<INF1>) {
  ...
  if ($inline =~ /^ATOM/ ) {   
	  ...
	  if ( $linearray[2] eq $backedUpAtomName_alt) { @backedUpAtom_alt = @linearray;}
	  ...
	  if( $linearray[2] eq $backingUpAtomName_alt ) { @backingUpAtom_alt = @linearray;}

	  if( $linearray[2] eq $backingUpResCAtomName) {@backingUpResCAtom = @linearray;}
      }
...
my @backingUpAtom_to_backedUpAtom_vect;
my @backingUpAtom_alt_to_backedUpAtom_vect;
my @backingUpAtom_to_backedUpAtom_vect_alt;
my @backingUpAtom_alt_to_backedUpAtom_vect_alt;

my @backingUpC_to_backingUpAtom_vect;
my @backingUpC_to_backingUpAtom_alt_vect;
...
$backingUpAtom_to_backedUpAtom_vect[0] = $backedUpAtom[6 + $pdbcheck] - $backingUpAtom[6 + $pdbcheck];
$backingUpAtom_to_backedUpAtom_vect[1] = $backedUpAtom[7 + $pdbcheck] - $backingUpAtom[7 + $pdbcheck];
$backingUpAtom_to_backedUpAtom_vect[2] = $backedUpAtom[8 + $pdbcheck] - $backingUpAtom[8 + $pdbcheck];

$backingUpAtom_to_backedUpAtom_vect_alt[0] = $backedUpAtom_alt[6 + $pdbcheck] - $backingUpAtom[6 + $pdbcheck];
$backingUpAtom_to_backedUpAtom_vect_alt[1] = $backedUpAtom_alt[7 + $pdbcheck] - $backingUpAtom[7 + $pdbcheck];
$backingUpAtom_to_backedUpAtom_vect_alt[2] = $backedUpAtom_alt[8 + $pdbcheck] - $backingUpAtom[8 + $pdbcheck];


$backingUpAtom_alt_to_backedUpAtom_vect[0] = $backedUpAtom[6 + $pdbcheck] - $backingUpAtom_alt[6 + $pdbcheck];
$backingUpAtom_alt_to_backedUpAtom_vect[1] = $backedUpAtom[7 + $pdbcheck] - $backingUpAtom_alt[7 + $pdbcheck];
$backingUpAtom_alt_to_backedUpAtom_vect[2] = $backedUpAtom[8 + $pdbcheck] - $backingUpAtom_alt[8 + $pdbcheck];

$backingUpAtom_alt_to_backedUpAtom_vect_alt[0] = $backedUpAtom_alt[6 + $pdbcheck] - $backingUpAtom_alt[6 + $pdbcheck];
$backingUpAtom_alt_to_backedUpAtom_vect_alt[1] = $backedUpAtom_alt[7 + $pdbcheck] - $backingUpAtom_alt[7 + $pdbcheck];
$backingUpAtom_alt_to_backedUpAtom_vect_alt[2] = $backedUpAtom_alt[8 + $pdbcheck] - $backingUpAtom_alt[8 + $pdbcheck];

$backingUpC_to_backingUpAtom_vect[0] = $backingUpResCAtom[6 + $pdbcheck] -  $backingUpAtom[6 + $pdbcheck];
$backingUpC_to_backingUpAtom_vect[1] = $backingUpResCAtom[7 + $pdbcheck] -  $backingUpAtom[7 + $pdbcheck];
$backingUpC_to_backingUpAtom_vect[2] = $backingUpResCAtom[8 + $pdbcheck] -  $backingUpAtom[8 + $pdbcheck];

$backingUpC_to_backingUpAtom_alt_vect[0] = $backingUpResCAtom[6 + $pdbcheck] -  $backingUpAtom_alt[6 + $pdbcheck];
$backingUpC_to_backingUpAtom_alt_vect[1] = $backingUpResCAtom[7 + $pdbcheck] -  $backingUpAtom_alt[7 + $pdbcheck];
$backingUpC_to_backingUpAtom_alt_vect[2] = $backingUpResCAtom[8 + $pdbcheck] -  $backingUpAtom_alt[8 + $pdbcheck];
...
my $backing_up_dist_alt = -1;
my $backing_up_alt_dist_alt = -1;
my $backing_up_alt_dist = -1;

my $backing_up_backed_up_angle;
my $backing_up_backed_up_alt_angle;
my $backing_up_alt_backed_up_angle;
my $backing_up_alt_backed_up_alt_angle;
...
if ($backingUpResNr) {
    ...
    $backing_up_dist_alt = &distance($backedUpAtom_alt[6 + $pdbcheck], $backedUpAtom_alt[7 + $pdbcheck], $backedUpAtom_alt[8 + $pdbcheck],$backingUpAtom[6 + $pdbcheck], $backingUpAtom[7 + $pdbcheck], $backingUpAtom[8 + $pdbcheck]);

    $backing_up_alt_dist = &distance($backedUpAtom[6 + $pdbcheck], $backedUpAtom[7 + $pdbcheck], $backedUpAtom[8 + $pdbcheck],$backingUpAtom_alt[6 + $pdbcheck], $backingUpAtom_alt[7 + $pdbcheck], $backingUpAtom_alt[8 + $pdbcheck]);

    $backing_up_alt_dist_alt = &distance($backedUpAtom_alt[6 + $pdbcheck], $backedUpAtom_alt[7 + $pdbcheck], $backedUpAtom_alt[8 + $pdbcheck],$backingUpAtom_alt[6 + $pdbcheck], $backingUpAtom_alt[7 + $pdbcheck], $backingUpAtom_alt[8 + $pdbcheck]);


    $backing_up_backed_up_angle = &angle($backingUpAtom_to_backedUpAtom_vect[0],$backingUpAtom_to_backedUpAtom_vect[1],$backingUpAtom_to_backedUpAtom_vect[2],$backingUpC_to_backingUpAtom_vect[0],$backingUpC_to_backingUpAtom_vect[1],$backingUpC_to_backingUpAtom_vect[2]);

    $backing_up_backed_up_alt_angle = &angle($backingUpAtom_to_backedUpAtom_vect_alt[0],$backingUpAtom_to_backedUpAtom_vect_alt[1],$backingUpAtom_to_backedUpAtom_vect_alt[2],$backingUpC_to_backingUpAtom_vect[0],$backingUpC_to_backingUpAtom_vect[1],$backingUpC_to_backingUpAtom_vect[2]);

    $backing_up_alt_backed_up_angle = &angle($backingUpAtom_alt_to_backedUpAtom_vect[0],$backingUpAtom_alt_to_backedUpAtom_vect[1],$backingUpAtom_alt_to_backedUpAtom_vect[2],$backingUpC_to_backingUpAtom_alt_vect[0],$backingUpC_to_backingUpAtom_alt_vect[1],$backingUpC_to_backingUpAtom_alt_vect[2]);

$backing_up_alt_backed_up_alt_angle = &angle($backingUpAtom_alt_to_backedUpAtom_vect_alt[0],$backingUpAtom_alt_to_backedUpAtom_vect_alt[1],$backingUpAtom_alt_to_backedUpAtom_vect_alt[2],$backingUpC_to_backingUpAtom_alt_vect[0],$backingUpC_to_backingUpAtom_alt_vect[1],$backingUpC_to_backingUpAtom_alt_vect[2]);
...
if($backingUpResNr) {
    printf STDOUT "${decoy} %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f backup: %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f\n",$DecLigE, $DecTotE, $C_hetbase_dist, $C_H_O_angle, $H_O_hetcarb1_angle,$torsion_OorN_to_C1, $C_hetbase_dist_alt, $C_H_O_angle_alt, $H_O_hetcarb1_angle_alt, $torsion_OorN_to_C1_alt, $backing_up_dist,$backing_up_backed_up_angle,$backing_up_dist_alt, $backing_up_backed_up_alt_angle, $backing_up_alt_dist, $backing_up_alt_backed_up_angle,$backing_up_alt_dist_alt,$backing_up_alt_backed_up_alt_angle; 
}
