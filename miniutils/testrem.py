...
def usage():
    print """Script to read in a list of logfiles from a remodel run and determine which secondary struture strings let to successes/failure how many times
"""
...
for file in file_list:
    ...
    for line in file_lines:
        if line[0:7] == "devel.e":
            ...
            elif (elements[1] == "Remodel" ) and (elements[3] == "success"):
                if cur_ss != elements[7]:
