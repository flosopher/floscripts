...
out.close()
print base_name
system('/users/sraman/bin/latex '+base_name+'.tex 2> /dev/null > /dev/null')
assert exists(base_name+'.dvi')

system('/users/sraman/bin/dvips -o '+out_file+' '+base_name+'.dvi 2> /dev/null > /dev/null')
